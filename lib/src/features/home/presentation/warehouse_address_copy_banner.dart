...
class WarehouseAddressCopyBannerContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final message = tr(
      context,
      ru:
          'После того как добавите адрес склада в китайский '
          'маркетплейс, обязательно отправьте в чат поддержки '
          'скриншот с площадки, чтобы наши менеджеры могли проверить, '
          'правильно ли вы указали адрес.',
      zh:
          '将仓库地址添加到中国电商平台后，请务必把平台上的地址截图发送到客服聊天，'
          '以便我们的经理检查地址是否填写正确。',
    );
