...
class SelfBuyoutService {
  ...
  Future<SelfBuyoutAvailability> getAvailability() async {
    try {
      ...
      if (res.statusCode == 200 && res.data is Map) {
        return SelfBuyoutAvailability.fromJson(res.data as Map<String, dynamic>);
      }
  ...
  Future<SelfBuyoutRequest> createRequest({
    ...
    return SelfBuyoutRequest.fromJson(res.data['request'] as Map<String, dynamic>);
  }
  ...
  Future<SelfBuyoutPaymentInfo?> startBankQr(int requestId) async {
    ...
    if (res.statusCode == 200 && res.data is Map) {
      return SelfBuyoutPaymentInfo.fromStartJson(res.data as Map<String, dynamic>);
    }
    return null;
  }
...
final selfBuyoutAvailabilityProvider =
    FutureProvider<SelfBuyoutAvailability>((ref) async {
